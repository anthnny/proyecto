      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <Nav.Link href="#skills" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('skills')}>Hierbas </Nav.Link>
          ...
          <span className="navbar-text">
            ...
            <button className="vvd" onClick={() => console.log('connect')}><span>Register | Login</span></button>
          </span>
        </Navbar.Collapse>
      </Container>
    </Navbar>
